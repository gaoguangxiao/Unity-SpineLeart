...
public class Message
{
    ...
    public Message(byte type, string command, string content)
    {
        Type = type;
        Command = command;
        Content = content;
    ...
    public Message(byte type, string command, Dictionary<string, object> dict)
    {
        Type = type;
        Command = command;
...
public class MessageType {
    //类型
    public static byte Type_Net = 1;
    public static byte Type_UI = 2;
    public static byte Type_plug = 3;//插件功能
